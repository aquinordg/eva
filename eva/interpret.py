...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "meta": {
        "en": "Generated by EVA &mdash; EEG data Validation and preprocessing Assistant &middot; recording: {stem}",
        "pt-br": "Gerado pela EVA &mdash; EEG data Validation and preprocessing Assistant &middot; gravação: {stem}",
    },
    "note_intro": {
        "en": (
    ...
    "footer": {
        "en": "EVA &mdash; EEG data Validation and preprocessing Assistant",
        "pt-br": "EVA &mdash; EEG data Validation and preprocessing Assistant",
    },
